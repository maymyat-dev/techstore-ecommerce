...
--> statement-breakpoint
ALTER TABLE "orderProduct" ADD CONSTRAINT "orderProduct_productVariantID_productsVariants_id_fk" FOREIGN KEY ("productVariantID") REFERENCES "public"."productsVariants"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
